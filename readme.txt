Le dossier code contient les trois fichiers de code en C++.

Le dossier result contient les fichiers textes des résultats obtenus selon les différentes méthodes 
(implicite et implicite-Crank Nicolson) et les types d'options (call ou put). La première valeur
